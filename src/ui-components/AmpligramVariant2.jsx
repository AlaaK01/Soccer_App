...
export default function AmpligramVariant2(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "AmpligramVariant2")}
      {...rest}
    >
      <Flex
        gap="16px"
      ...
      >
        ...
        >
          <Image
            ...
            padding="0px 0px 0px 0px"
            objectFit="cover"
            {...getOverrideProps(overrides, "image37682745")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon37682748")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vector37682749")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        padding="0px 0px 0px 0px"
        objectFit="cover"
        {...getOverrideProps(overrides, "image37682750")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon37682753")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            {...getOverrideProps(overrides, "MyIcon37682754")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            padding="0px 0px 0px 0px"
            type="send"
            {...getOverrideProps(overrides, "MyIcon37682755")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon37682757")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vector37682758")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
