...
export default function CompetitionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const validations = {
    name: [{ type: "Required" }],
    logoUrl: [{ type: "Required" }, { type: "URL" }],
    year: [],
    country: [],
    imageUrl: [{ type: "URL" }],
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Competition(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CompetitionCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
