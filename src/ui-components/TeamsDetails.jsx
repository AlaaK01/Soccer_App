...
export default function TeamsDetails(props) {
  const { teamdetails, area, overrides, ...rest } = props;
  return (
    <Flex
      gap="8px"
      direction="column"
      ...
      {...getOverrideProps(overrides, "TeamsDetails")}
      {...rest}
    >
      <Flex
        gap="16px"
      ...
      >
        ...
        >
          <Image
            ...
            padding="0px 0px 0px 0px"
            objectFit="cover"
            src={teamdetails?.logoUrl}
            {...getOverrideProps(overrides, "image37772793")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon37772796")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vector37772797")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        {...getOverrideProps(overrides, "image37772798")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon37772801")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            {...getOverrideProps(overrides, "MyIcon37772802")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            padding="0px 0px 0px 0px"
            type="send"
            {...getOverrideProps(overrides, "MyIcon37772803")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon37772805")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vector37772806")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${teamdetails?.country}${"          City: "}${
              teamdetails?.city
            }`}
            {...getOverrideProps(
              overrides,
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${"Coach: "}${teamdetails?.coach}`}
