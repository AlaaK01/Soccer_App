...
export default function CompetitionDetails(props) {
  const { competition, area, overrides, ...rest } = props;
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "CompetitionDetails")}
      {...rest}
    >
      <Flex
        gap="16px"
      ...
      >
        ...
        >
          <Image
            ...
            {...getOverrideProps(overrides, "image37682772")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon37682775")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vector37682776")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        {...getOverrideProps(overrides, "image37682777")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon37682780")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            {...getOverrideProps(overrides, "MyIcon37682781")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            padding="0px 0px 0px 0px"
            type="send"
            {...getOverrideProps(overrides, "MyIcon37682782")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon37682784")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vector37682785")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
